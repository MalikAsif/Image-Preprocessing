...
def noiseEstimation():
    for i in range(1318):
        ...
        print(org_img)
        exist = os.path.exists("/Users/adilyousuf/Documents/NCAI/DIP - First Paper/Assignment 6/assets/Preprocessed Data/data/train/Malignant/{0}.png".format(i + 1))
        if not exist:
            continue


        url = "/Users/adilyousuf/Documents/NCAI/DIP - First Paper/Assignment 6/assets/Preprocessed Data/data/train/Malignant/{0}.png".format(i + 1)
        print(url)
        ...
        # new_img = "/Users/adilyousuf/Documents/NCAI/DIP - First Paper/Assignment 6/assets/Preprocessed Data/1/train/Benign/{0}.png".format(i + 1)
        # org_img = array(org_img)
        # cv2.imwrite(new_img, out)
        # addImage(columns * i + 4, out, rows, org_img)
        ...
        new_img = "/Users/adilyousuf/Documents/NCAI/DIP - First Paper/Assignment 6/assets/Preprocessed Data/2/train/Malignant/{0}.png".format(i + 1)
